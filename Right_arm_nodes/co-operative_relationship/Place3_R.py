        ...
        while not self.stop_event.is_set() and not loop_executed:
            ...
            if is_attached3 == True and (is_known3 == False):
               # Create a list of place locations to be attempted, currently only creating a single place location.
                ...
                place_location.pre_place_approach.min_distance = 0.15
                ...
                move_group.place("object3", place_location)
                ...
                if is_attached3 == False and (is_known3 == True):
